...
//                thread1.start();
        ...
        timer.schedule(task, 1000L, 5000);
    }
...
//            Log.e("onReceive", intent.getStringExtra("progress"));
//            tv.setText(intent.getStringExtra("progress")+"");
